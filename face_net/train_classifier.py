import numpy as np
from sklearn.linear_model import LogisticRegression  # ← GANTI DARI SVC
...
# Pipeline: standardize -> Logistic Regression  # ← GANTI INI
clf = Pipeline([
    ("scaler", StandardScaler()),
    ("classifier", LogisticRegression(C=10, random_state=42))  # ← GANTI INI
])
